...
public class Game {
	...
	public void dealerDraw() {
		...
		dealerCardValue[dealerHas] = checkCardValue(); // Register the card value. If it's from Jack to King, it returns
														// 10
	...
	public void playerTurn() {
		...
		if (playerTotalValue > 21) { // If the total value surpassed 21, the game is over
			...
			if (playerHas > 1 && playerHas < 5) { // If the total value is less than 22 and has 4 or less cards, you can
													// still hit
